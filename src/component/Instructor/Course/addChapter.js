...
class AddChapter extends Component {
    ...
    render() {
        return (
            <Container style={{ marginTop: "30px", width: "50%", boxShadow: "4px 2px 4px 2px", color: "grey" }}>
                <h1>Add Chapter</h1>
                <Form >
                    <FormGroup>
                        <Label className="chphead">Let's have a chapter name here</Label>
                    ...
                    <FormGroup className="doc">
                        <FilePond
                            files={this.state.files}
                            allowMultiple={true}
                            onupdatefiles={(files) => this.documentUpdate(files)}
                            labelIdle='Fill your chapter with documents!! Click Here'
                        />
